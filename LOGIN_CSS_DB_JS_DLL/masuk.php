              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="checklogin.php">
                    ...
                    <div class="text"> 
                    <input type="radio" name="hakakses" value="2" />&nbsp;Admin &nbsp;&nbsp;
                    <input type="radio" name="hakakses" value="1" />&nbsp;Customer
                    </div>
                  </div>
                </div>
                    <input class="btn btn-primary btn-user btn-block" type="submit" name="Submit" value="Masuk"></a>
                  </form>
                  <hr>
                  <div class="text-center">
