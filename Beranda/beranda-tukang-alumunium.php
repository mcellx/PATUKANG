	...
	<?php
				...
				<lia style="padding-left: 30px">
					<img src="patukang.png" width="70">
									  ...
									  <li style="padding-top: 20px">
									   ...
									   <li style="padding-top: 20px">
									  <?php
										echo "<a class='nav-link' href='daftartukang.php?user=$cekdata[nam_leng]'>"
										?>
											Daftar Tukang
										<?php
										echo"</a>";
			...
			<div class="col-lg-4 col-md-12 col-sm-12" style="text-align: center;padding-left:20px">
				...
				<table class="table" style="font-family:Arial;">
					<tr>
						...
						<?php echo "<a href='beranda-harga-tertinggi.php?user=$cekdata[nam_leng]'>";?>
						<p style="font-size:11px;text-align: center;">Tertinggi <?php echo "</a>"; ?> | <?php echo "<a href='beranda-harga-terendah.php?user=$cekdata[nam_leng]'>";?>
						Terendah</p> <?php echo "</a>"; ?>
						</td>
						<td style="padding-right:80px;padding-top:20px">
						<img src="star.png" width="35">
						<?php echo "<a href='beranda-rating.php?user=$cekdata[nam_leng]'>";?>
		...
		<h6 align="center" style="font-family:arial black ;color: orange;">Kategori Jasa Tukang</h6>		
				<table class="table" style="font-family:Arial;">
					...
					<tr>
						<td>
						<img src="beranda.png" width="60" style="padding-left:25px;padding-top:5px">
						<?php echo "<a href='beranda.php?user=$cekdata[nam_leng]'>";?>
						<p style="text-align: center;font-size:11px">Semua Kategori</p>
						<?php
						echo "</a>";
						?>
						</td>
		...
		<div class="container-fixed" style="margin-top:30px">
			...
			<h6 style="text-align: center;color: orange;padding-bottom:10px">Tukang Alumunium</h6><hr style="border-width:2px"><br>  
			<div class="row">
		<?php  
		$Keahlian = "Tukang Alumunium";
