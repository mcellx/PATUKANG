...
<body>
	...
	<?php
		...
		<h6 align="center" style="font-family:arial black ;color: orange;">Kategori Jasa Tukang</h6>		
				<table class="table" style="font-family:Arial;">
					...
					<tr>
						...
						<?php echo "<a href='beranda-tukang-keramik.php?id_customer=$cekdata[id_customer]'>";?>
						...
						<?php echo "<a href='beranda-tukang-plafon.php?'>";?>
		...
		<div class="container-fixed" style="margin-top:30px">
			...
			<h6 style="text-align: center;color: orange;padding-bottom:10px">Tukang Atap</h6><hr style="border-width:2px"><br>  
			<div class="row">
		<?php  
		$Keahlian = "Tukang Atap";
